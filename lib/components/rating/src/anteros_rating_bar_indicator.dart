...
class AnterosRatingBarIndicator extends StatefulWidget {
  AnterosRatingBarIndicator({
  ...
  @override
  _AnterosRatingBarIndicatorState createState() => _AnterosRatingBarIndicatorState();
}

class _AnterosRatingBarIndicatorState extends State<AnterosRatingBarIndicator> {
