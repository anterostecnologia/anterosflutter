...
///
/// [AnterosRatingBar] can also be used to display rating
///
...
class AnterosRatingBar extends StatefulWidget {
  /// Creates [AnterosRatingBar] using the [ratingWidget].
  const AnterosRatingBar({
    /// Customizes the Rating Bar item with [RatingWidget].
    required AnterosRatingWidget ratingWidget,
  ...
  /// Creates [AnterosRatingBar] using the [itemBuilder].
  const AnterosRatingBar.builder({
  ...
  /// How the item within the [AnterosRatingBar] should be placed in the main axis.
  ///
  ...
  final AnterosRatingWidget? _ratingWidget;

  @override
  _AnterosRatingBarState createState() => _AnterosRatingBarState();
}

class _AnterosRatingBarState extends State<AnterosRatingBar> {
  double _rating = 0.0;
  bool _isRTL = false;
  ...
  @override
  void didUpdateWidget(AnterosRatingBar oldWidget) {
