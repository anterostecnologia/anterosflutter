...
/// The [AnterosSideBySide] widget disposes 2 widgets horizontally, while achieving a layout which is
/// impossible for both the native [Row] and the [ AnterosRow] widgets.
///
...
///
///
class AnterosSideBySide extends MultiChildRenderObjectWidget {
  //
  ...
  @override
  _RenderSideBySide createRenderObject(BuildContext context) =>
      _RenderSideBySide(
  ...
  void updateRenderObject(
      BuildContext context, _RenderSideBySide renderObject) {
    renderObject
      ..crossAxisAlignment = crossAxisAlignment
      ..innerDistance = innerDistance
      ..minEndChildWidth = minEndChildWidth;
...
class _RenderSideBySide extends RenderBox
  ...
  void _performLayout() {
    ...
    var endChildConstraints = constraints.tighten(
        width: constraints.maxWidth - startChildWidth - innerDistance);
