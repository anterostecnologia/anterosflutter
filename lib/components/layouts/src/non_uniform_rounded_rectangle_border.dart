...
///
class AnterosNonUniformRoundedRectangleBorder extends OutlinedBorder {
  //
  /// Creates a rounded rectangle border.
  const AnterosNonUniformRoundedRectangleBorder({
  ...
  ShapeBorder? lerpFrom(ShapeBorder? a, double t) {
    if (a is AnterosNonUniformRoundedRectangleBorder) {
      return AnterosNonUniformRoundedRectangleBorder(
  ...
  ShapeBorder? lerpTo(ShapeBorder? b, double t) {
    if (b is AnterosNonUniformRoundedRectangleBorder) {
      return AnterosNonUniformRoundedRectangleBorder(
  ...
  /// Returns a copy of this [AnterosNonUniformRoundedRectangleBorder\ with the given fields
  /// replaced with the new values.
  @override
  AnterosNonUniformRoundedRectangleBorder copyWith({
    BorderSide? side,
  ...
  Path getOuterPath(Rect rect, {TextDirection? textDirection}) {
    return Path()
      ..addRRect(_borderRadius(rect).resolve(textDirection).toRRect(rect));
  }
  ...
  BorderRadius _borderRadius(Rect rect) {
    ...
    return BorderRadius.only(
      topLeft: (showTopSide && showLeftSide)
          ? Radius.circular(tlRadius)
          : Radius.zero,
      topRight: (showTopSide && showRightSide)
          ? Radius.circular(trRadius)
          : Radius.zero,
      bottomLeft: (showBottomSide && showLeftSide)
          ? Radius.circular(blRadius)
          : Radius.zero,
      bottomRight: (showBottomSide && showRightSide)
          ? Radius.circular(brRadius)
          : Radius.zero,
    );
  }
  ...
  Path _path(Canvas canvas, Rect rect) {
    ...
    if (showTopSide && showRightSide && showBottomSide && showLeftSide)
      path
        ...
        ..arcToIf(topRightCorner, -pi / 2, pi / 2, true,
            ifRadiusNonZero: topRightRadius)
        ..lineTo(rect.right, rect.bottom - bottomRightRadius)
        ..arcToIf(bottomRightCorner, 0, pi / 2, true,
            ifRadiusNonZero: bottomRightRadius)
        ..lineTo(rect.left + bottomLeftRadius, rect.bottom)
        ..arcToIf(bottomLeftCorner, pi / 2, pi / 2, true,
            ifRadiusNonZero: bottomLeftRadius)
        ..lineTo(rect.left, rect.top + topLeftRadius)
        ..arcToIf(topLeftCorner, pi, pi / 2, true,
            ifRadiusNonZero: topLeftRadius);
    //
  ...
  bool operator ==(Object other) =>
      ...
      other is AnterosNonUniformRoundedRectangleBorder &&
