...
/// [AnterosPad] is an [EdgeInsetsGeometry] which is easy to type and remember.
///
...
///
///
class AnterosPad extends EdgeInsets {
  ...
  ///
  /// ```dart
  /// const AnterosPad(all: 40.0, top: 10);
  /// ```
  ///
  const AnterosPad({
    double all = 0.0,
  ...
  /// the [AnterosPad] class to remove it. It's marked as [deprecated] so that you don't
