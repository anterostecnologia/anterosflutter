...
///
/// A [AnterosNormalizedOverflowBox] is similar to an [OverflowBox]. The difference
...
///
/// However, the [AnterosNormalizedOverflowBox] will just make sure maxWidth is
/// also 150, and throw no errors. In other words, a [AnterosNormalizedOverflowBox]
/// is safer to use. In my opinion, [AnterosNormalizedOverflowBox] has the behavior
...
class AnterosNormalizedOverflowBox extends SingleChildRenderObjectWidget {
  /// Creates a widget that lets its child overflow itself,
  /// but prevents invalid constraints.
  const AnterosNormalizedOverflowBox({
    Key? key,
  ...
  @override
  RenderConstrainedNormalizedOverflowBox createRenderObject(
  ...
  void updateRenderObject(BuildContext context,
      RenderConstrainedNormalizedOverflowBox renderObject) {
    renderObject
      ..alignment = alignment
      ..minWidth = minWidth
      ..maxWidth = maxWidth
