...
///
class AnterosNonUniformOutlineBorder extends InputBorder {
  ...
  ///
  const AnterosNonUniformOutlineBorder({
  ...
  @override
  AnterosNonUniformOutlineBorder copyWith({
  ...
  @override
  AnterosNonUniformOutlineBorder scale(double t) {
    return AnterosNonUniformOutlineBorder(
  ...
  ShapeBorder? lerpFrom(ShapeBorder? a, double t) {
    if (a is AnterosNonUniformOutlineBorder) {
      final AnterosNonUniformOutlineBorder outline = a;
      return AnterosNonUniformOutlineBorder(
  ...
  ShapeBorder? lerpTo(ShapeBorder? b, double t) {
    if (b is AnterosNonUniformOutlineBorder) {
      final AnterosNonUniformOutlineBorder outline = b;
      return AnterosNonUniformOutlineBorder(
  ...
  bool operator ==(Object other) =>
      ...
      other is AnterosNonUniformOutlineBorder &&
