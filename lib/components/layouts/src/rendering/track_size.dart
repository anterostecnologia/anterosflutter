...
/// Passed to [AnterosTrackSize] functions to indicate the type of track whose
/// cross-axis is being measured.
enum AnterosTrackType {
  column,
  row,
}

/// Returns the direction of cell layout for the provided [type].
Axis mainAxisForTrackType(AnterosTrackType type) =>
    type == AnterosTrackType.column ? Axis.vertical : Axis.horizontal;

/// Returns the axis measured by a [AnterosTrackSize] associated with a particular
/// [AnterosTrackType].
Axis measurementAxisForTrackType(AnterosTrackType type) {
  return type == AnterosTrackType.column ? Axis.horizontal : Axis.vertical;
}
...
@immutable
abstract class AnterosTrackSize with Diagnosticable {
  /// Abstract const constructor. This constructor enables subclasses to provide
  /// const constructors so that they can be used in const expressions.
  const AnterosTrackSize({this.debugLabel});
  ...
  bool isFixedForConstraints(
      AnterosTrackType type, BoxConstraints gridConstraints) {
    return false;
  }
...
class FixedTrackSize extends AnterosTrackSize {
...
class FlexibleTrackSize extends AnterosTrackSize {
...
bool trackSizeListsEqual(List<AnterosTrackSize> a, List<AnterosTrackSize> b) {
