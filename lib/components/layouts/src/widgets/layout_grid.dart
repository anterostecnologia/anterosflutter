...
class AutoPlacement {
  ...
  static const rowSparse =
      AutoPlacement._(AnterosTrackType.row, AutoPlacementPacking.sparse);
  ...
  static const rowDense =
      AutoPlacement._(AnterosTrackType.row, AutoPlacementPacking.dense);

  /// Items are placed by filling each column in turn, adding new columns as
  /// necessary.
  static const columnSparse =
      AutoPlacement._(AnterosTrackType.column, AutoPlacementPacking.sparse);
  ...
  static const columnDense =
      AutoPlacement._(AnterosTrackType.column, AutoPlacementPacking.dense);

  const AutoPlacement._(this.trackType, this.packing);
  final AnterosTrackType trackType;
...
class AnterosLayoutGrid extends MultiChildRenderObjectWidget {
  AnterosLayoutGrid({
    Key? key,
  ...
  @override
  AnterosRenderLayoutGrid createRenderObject(BuildContext context) {
    return AnterosRenderLayoutGrid(
  ...
  void updateRenderObject(
      BuildContext context, AnterosRenderLayoutGrid renderObject) {
    renderObject
      ..autoPlacement = autoPlacement
      ..gridFit = gridFit
      ..areasSpec = areas
