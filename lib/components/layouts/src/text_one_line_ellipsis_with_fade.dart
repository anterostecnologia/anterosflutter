...
/// [AnterosTextOneLineEllipsisWithFade] is a substitute for [Text] when [maxLines] is 1.
///
...
class AnterosTextOneLineEllipsisWithFade extends StatelessWidget
    implements Text {
  @override
  final String data;
  ...
  const AnterosTextOneLineEllipsisWithFade(
    this.data, {
    Key? key,
    this.style,
    this.strutStyle,
