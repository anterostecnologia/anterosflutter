...
///
class AnterosCircularStepProgressIndicator extends StatelessWidget {
  /// Defines if steps grow from
  /// clockwise [AnterosCircularDirection.clockwise] or
  /// counterclockwise [AnterosCircularDirection.counterclockwise]
  final AnterosCircularDirection circularDirection;
  ...
  const AnterosCircularStepProgressIndicator({
    ...
    this.roundedCap,
    this.gradientColor,
    this.circularDirection = AnterosCircularDirection.clockwise,
...
class _CircularIndicatorPainter implements CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final isClockwise = circularDirection == AnterosCircularDirection.clockwise;
  ...
  void _drawContinuousArc(
    ...
    if (circularDirection == AnterosCircularDirection.clockwise) {
...
/// Used to define the [circularDirection] attribute of the [AnterosCircularStepProgressIndicator]
enum AnterosCircularDirection {
  clockwise,
  counterclockwise,
}
