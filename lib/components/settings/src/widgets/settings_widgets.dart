...
import '../../anteros_flutter_settings.dart';
...
/// [AnterosSettingsTile] is a simple settings tile that can open a new screen
/// by tapping the tile.
///
/// Example:
/// ```dart
...
/// );
/// ```
class AnterosSettingsTile extends StatelessWidget {
...
/// [AnterosModalSettingsTile] is a widget which allows creating
...
/// ```
///
class AnterosModalSettingsTile<T> extends StatelessWidget {
  /// title string for the tile
  final String title;
...
/// [AnterosExpandableSettingsTile] is wrapper widget which shows the
...
///
/// ```
class AnterosExpandableSettingsTile extends StatelessWidget {
  /// title string for the tile
  final String title;
  ...
  Widget build(BuildContext context) {
    return _ExpansionSettingsTile(
      ...
      child: AnterosSettingsContainer(
        children: children,
      ),
    );
  }
...
/// [AnterosSettingsContainer] is a widget that helps its child or children to fit in
...
/// );
/// ```
class AnterosSettingsContainer extends StatelessWidget {
...
/// [AnterosSettingsGroup] is a widget that contains multiple settings tiles and other
...
///  );
/// ```
class AnterosSettingsGroup extends StatelessWidget {
  /// title string for the tile
  final String title;
...
/// );
/// ```
class AnterosTextInputSettingsTile extends StatefulWidget {
  ...
  final OnChangedSettingsItem<String>? onChange;
  ...
  @override
  _AnterosTextInputSettingsTileState createState() =>
      _AnterosTextInputSettingsTileState();
}

class _AnterosTextInputSettingsTileState
    extends State<AnterosTextInputSettingsTile> {
  ...
  Widget build(BuildContext context) {
    return ValueChangeObserver<String>(
      ...
      builder: (BuildContext context, String value,
          OnChangedSettingsItem<String> onChanged) {
        ...
        return _ModalSettingsTile<String>(
          ...
          onCancel: () {
            _controller.text = AnterosSettings.getValue(widget.settingKey, '');
          },
          children: <Widget>[
  ...
  void _onSave(String? newValue, OnChangedSettingsItem<String> onChanged) {
...
/// [AnterosSwitchSettingsTile] is a widget that has a [Switch] with given title,
...
///
/// This widget works similar to [AnterosCheckboxSettingsTile].
///
///  Example:
///
/// ```dart
...
///  );
///  ```
class AnterosSwitchSettingsTile extends StatelessWidget {
  ...
  /// on change callback for handling the value change
  final OnChangedSettingsItem<bool>? onChange;
  ...
  Widget build(BuildContext context) {
    return ValueChangeObserver<bool>(
      ...
      builder: (BuildContext context, bool value,
          OnChangedSettingsItem<bool> onChanged) {
  ...
  Future<void> _onSwitchChange(BuildContext context, bool? value,
      OnChangedSettingsItem<bool> onChanged) async {
  ...
  Widget getFinalWidget(BuildContext context, Widget mainWidget,
    ...
    if (childrenIfEnabled == null || !currentValue) {
      return AnterosSettingsContainer(
        children: [mainWidget],
      );
    }
...
/// [AnterosCheckboxSettingsTile] is a widget that has a [Checkbox] with given title,
...
/// through `childrenIfEnabled` property of this widget.
///
/// This widget works similar to [AnterosSwitchSettingsTile].
///
///  Example:
///
/// ```dart
...
///  );
///  ```
class AnterosCheckboxSettingsTile extends StatelessWidget {
  ...
  Future<void> _onCheckboxChange(
      bool? value, OnChangedSettingsItem<bool> onChanged) async {
    if (value == null) return;
    onChanged(value);
    onChange?.call(value);
  }
...
/// [AnterosRadioSettingsTile] is a widget that has a list of [Radio] widgets with given title,
...
/// )
/// ```
class AnterosRadioSettingsTile<T> extends StatefulWidget {
  ...
  /// on change callback for handling the value change
  final OnChangedSettingsItem<T>? onChange;

  /// A Widget that will be displayed in the front of the tile
  final Widget? leading;

  AnterosRadioSettingsTile({
    required this.title,
    required this.settingKey,
  ...
  @override
  _AnterosRadioSettingsTileState<T> createState() =>
      _AnterosRadioSettingsTileState<T>();
}

class _AnterosRadioSettingsTileState<T>
    extends State<AnterosRadioSettingsTile<T>> {
  ...
  Future<void> _onRadioChange(
      T? value, OnChangedSettingsItem<T> onChanged) async {
    if (value == null) return;
    selectedValue = value;
    onChanged(value);
  ...
  Widget build(BuildContext context) {
    return ValueChangeObserver<T>(
      ...
      builder:
          (BuildContext context, T value, OnChangedSettingsItem<T> onChanged) {
        return AnterosSettingsContainer(
          children: <Widget>[
            Visibility(
              visible: showTitles,
  ...
  Widget _buildRadioTiles(
      BuildContext context, T groupValue, OnChangedSettingsItem<T> onChanged) {
    var radioList =
...
/// [AnterosDropDownSettingsTile] is a widget that has a list of [DropdownMenuItem]s
...
/// );
/// ```
class AnterosDropDownSettingsTile<T> extends StatefulWidget {
  /// Settings Key string for storing the state of Radio buttons in cache (assumed to be unique)
  final String settingKey;
  ...
  @override
  _AnterosDropDownSettingsTileState<T> createState() =>
      _AnterosDropDownSettingsTileState<T>();
}

class _AnterosDropDownSettingsTileState<T>
    extends State<AnterosDropDownSettingsTile<T>> {
  late T selectedValue;
...
/// [AnterosSliderSettingsTile] is a widget that has a slider given title,
...
/// );
/// ```
class AnterosSliderSettingsTile extends StatefulWidget {
  ...
  /// on change callback for handling the value change
  final OnChangedSettingsItem<double>? onChange;

  /// callback for fetching the value slider movement starts
  final OnChangedSettingsItem<double>? onChangeStart;

  /// callback for fetching the value slider movement ends
  final OnChangedSettingsItem<double>? onChangeEnd;
  ...
  @override
  _AnterosSliderSettingsTileState createState() =>
      _AnterosSliderSettingsTileState();
}

class _AnterosSliderSettingsTileState extends State<AnterosSliderSettingsTile> {
  ...
  Widget build(BuildContext context) {
    return ValueChangeObserver<double>(
      ...
      builder: (BuildContext context, double value,
          OnChangedSettingsItem<double> onChanged) {
  ...
  void _updateWidget(double newValue, OnChangedSettingsItem<double> onChanged) {
    currentValue = newValue;
    onChanged(newValue);
  }

  void _handleSliderChanged(
      double newValue, OnChangedSettingsItem<double> onChanged) {
    _updateWidget(newValue, onChanged);
    widget.onChange?.call(newValue);
  }

  void _handleSliderChangeStart(
      double newValue, OnChangedSettingsItem<double> onChanged) {
    _updateWidget(newValue, onChanged);
  ...
  Future<void> _handleSliderChangeEnd(
      double newValue, OnChangedSettingsItem<double> onChanged) async {
    _updateWidget(newValue, onChanged);
    widget.onChangeEnd?.call(newValue);
  }
}

/// [AnterosColorPickerSettingsTile] is a widget which allows user to
...
///  );
/// ```
class AnterosColorPickerSettingsTile extends StatefulWidget {
  ...
  /// on change callback for handling the value change
  final OnChangedSettingsItem<Color>? onChange;
  ...
  @override
  _AnterosColorPickerSettingsTileState createState() =>
      _AnterosColorPickerSettingsTileState();
}

class _AnterosColorPickerSettingsTileState
    extends State<AnterosColorPickerSettingsTile> {
  ...
  Future<void> _handleColorChanged(
      String color, OnChangedSettingsItem<String> onChanged) async {
    currentValue = color;
    onChanged(color);
...
/// [AnterosRadioModalSettingsTile] widget is the dialog version of the
/// [AnterosRadioSettingsTile] widget.
///
/// Meaning this widget is similar to a [AnterosRadioSettingsTile] shown in a dialog.
///
/// Use of this widget is similar to the [AnterosRadioSettingsTile], only the displayed
...
/// ```
///
class AnterosRadioModalSettingsTile<T> extends StatefulWidget {
  ...
  @override
  _AnterosRadioModalSettingsTileState<T> createState() =>
      _AnterosRadioModalSettingsTileState<T>();
}

class _AnterosRadioModalSettingsTileState<T>
    extends State<AnterosRadioModalSettingsTile<T>> {
  late T selectedValue;
...
/// [AnterosSliderModalSettingsTile] widget is the dialog version of the
/// [AnterosSliderSettingsTile] widget.
///
/// Meaning this widget is similar to a [AnterosSliderSettingsTile] shown in a dialog.
///
/// Use of this widget is similar to the [AnterosSliderSettingsTile], only the displayed
/// widget will be in a different position. i.e instead of the settings screen,
/// it will be shown in a dialog above the settings screen.
///
/// Example:
...
/// ```
///
class AnterosSliderModalSettingsTile extends StatefulWidget {
  /// Settings Key string for storing the state of Slider in cache (assumed to be unique)
  final String settingKey;
  ...
  AnterosSliderModalSettingsTile({
    required this.title,
    required this.settingKey,
    required this.min,
    required this.max,
  ...
  @override
  _AnterosSliderModalSettingsTileState createState() =>
      _AnterosSliderModalSettingsTileState();
}

class _AnterosSliderModalSettingsTileState
    extends State<AnterosSliderModalSettingsTile> {
  late double currentValue;
...
/// [AnterosDefaultRadioSettingsTile] is a simpler version of
/// the [AnterosRadioSettingsTile].
///
...
/// );
/// ```
class AnterosDefaultRadioSettingsTile extends StatelessWidget {
  /// Settings Key string for storing the state of Radio setting in cache (assumed to be unique)
  final String settingKey;
  ...
  @override
  Widget build(BuildContext context) {
    return AnterosRadioSettingsTile<String>(
      title: title,
      subtitle: subtitle,
      leading: leading,
...
/// [AnterosDefultDropDownSettingsTile] is a simpler version of
/// the [AnterosDropDownSettingsTile].
///
/// Instead of a Value-String map, this widget just takes a list
/// of String values.
///
...
/// );
/// ```
class AnterosDefultDropDownSettingsTile extends StatelessWidget {
  /// Settings Key string for storing the state of Radio buttons in cache (assumed to be unique)
  final String settingKey;
  ...
  @override
  Widget build(BuildContext context) {
    return AnterosDropDownSettingsTile<String>(
      title: title,
      subtitle: subtitle,
      leading: leading,
      settingKey: settingKey,
