...
/// [AnterosSettingsScreen] is a simple Screen widget that may contain Tiles or other
/// widgets.
///
/// * Example:
/// ```dart
...
/// );
/// ```
class AnterosSettingsScreen extends StatelessWidget {
...
class _SettingsCheckbox extends StatelessWidget {
  ...
  final OnChangedSettingsItem<bool?> onChanged;
...
class _SettingsRadio<T> extends StatelessWidget {
  ...
  /// on change callback to handle state change
  final OnChangedSettingsItem<T?> onChanged;
...
class _SettingsDropDown<T> extends StatelessWidget {
  ...
  final SetttingsItemBuilder<T> itemBuilder;
...
class _SettingsSlider extends StatelessWidget {
  ...
  final OnChangedSettingsItem<double>? onChanged;
...
class _SettingsColorPicker extends StatelessWidget {
  ...
  /// on change callback to handle the value change
  final OnChangedSettingsItem<String> onChanged;
  ...
  void _showColorPicker(BuildContext context, String value) {
    Widget dialogContent = AnterosMaterialColorPicker(
      shrinkWrap: true,
