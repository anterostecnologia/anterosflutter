...
class AnterosMaterialColorPicker extends StatefulWidget {
  ...
  const AnterosMaterialColorPicker({
    Key? key,
    this.selectedColor,
    this.onColorChange,
  ...
  @override
  _AnterosMaterialColorPickerState createState() =>
      _AnterosMaterialColorPickerState();
}

class _AnterosMaterialColorPickerState
    extends State<AnterosMaterialColorPicker> {
  ...
  @protected
  @override
  void didUpdateWidget(covariant AnterosMaterialColorPicker oldWidget) {
    _initSelectedValue();
