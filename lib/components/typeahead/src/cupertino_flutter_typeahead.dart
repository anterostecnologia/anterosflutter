...
class AnterosCupertinoTypeAheadFormField<T> extends FormField<String> {
  ...
  /// Creates a [AnterosCupertinoTypeAheadFormField]
  AnterosCupertinoTypeAheadFormField(
      {Key? key,
      String? initialValue,
      ...
      : assert(
        ...
        super(
            ...
            builder: (FormFieldState<String> field) {
              final AnterosCupertinoTypeAheadFormFieldState state =
                  field as AnterosCupertinoTypeAheadFormFieldState<dynamic>;

              return AnterosCupertinoTypeAheadField(
  ...
  @override
  AnterosCupertinoTypeAheadFormFieldState<T> createState() =>
...
class AnterosCupertinoTypeAheadFormFieldState<T>
  ...
  @override
  AnterosCupertinoTypeAheadFormField get widget =>
      super.widget as AnterosCupertinoTypeAheadFormField<dynamic>;
  ...
  @override
  void didUpdateWidget(AnterosCupertinoTypeAheadFormField oldWidget) {
...
/// implementation of [TypeAheadField] that allows the value to be saved,
/// validated, etc.
class AnterosCupertinoTypeAheadField<T> extends StatefulWidget {
  ...
  /// Creates a [AnterosCupertinoTypeAheadField]
  AnterosCupertinoTypeAheadField(
      {Key? key,
  ...
  @override
  _AnterosCupertinoTypeAheadFieldState<T> createState() =>
