import 'package:anterosflutter/components/loading_more_list/src/empty_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    switch (status) {
      ...
      case IndicatorStatus.error:
        widget = Text(
          text ?? 'O carregamento falhou, tente novamente.',
        );
        widget = _setbackground(false, widget, 35.0);
        if (tryAgain != null) {
      ...
      case IndicatorStatus.noMoreLoad:
        widget = Text(text ?? 'Não há mais itens.');
        widget = _setbackground(false, widget, 35.0);
        break;
      case IndicatorStatus.empty:
        widget = AnterosEmptyWidget(
          text ?? 'nada aqui',
