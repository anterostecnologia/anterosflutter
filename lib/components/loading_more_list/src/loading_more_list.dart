import 'package:anterosflutter/components/loading_more_list/src/glow_notification_widget.dart';
import 'package:anterosflutter/components/loading_more_list/src/list_config/list_config.dart';
import 'package:flutter/material.dart';

import 'package:loading_more_list_library/loading_more_list_library.dart';

//loading more for listview and gridview
class AnterosLoadingMoreList<T> extends StatelessWidget {
  const AnterosLoadingMoreList(this.listConfig,
      {Key? key, this.onScrollNotification})
      : super(key: key);
  final AnterosListConfig<T> listConfig;
    ...
    return StreamBuilder<LoadingMoreBase<T>>(
      builder: (BuildContext d, AsyncSnapshot<LoadingMoreBase<T>> s) {
        return NotificationListener<ScrollNotification>(
            ...
            child: AnterosGlowNotificationWidget(
