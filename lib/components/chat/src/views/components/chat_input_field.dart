...
class AnterosChatInputField extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return AnterosChatInputFieldState();
  }
}

class AnterosChatInputFieldState extends State<AnterosChatInputField>
