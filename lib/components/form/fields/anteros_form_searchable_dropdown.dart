...
import 'package:anterosflutter/anterosflutter.dart' as dropdown_search;
import 'package:flutter/material.dart';

/// Field for selecting value(s) from a searchable list
class AnterosFormSearchableDropdown<T> extends AnterosFormField<T> {
...
class _FormBuilderSearchableDropdownState<T>
    extends AnterosFormFieldState<AnterosFormSearchableDropdown<T>, T> {}
