...
class AnterosFormFilterChip<T> extends AnterosFormField<List<T>> {
          ...
          builder: (FormFieldState<List<T>?> field) {
            ...
            return InputDecorator(
              ...
              child: Wrap(
                ...
                children: <Widget>[
                  for (AnterosFormFieldOption<T> option in options)
                    FilterChip(
                      label: option,
...
class _FormBuilderFilterChipState<T>
    extends AnterosFormFieldState<AnterosFormFilterChip<T>, List<T>> {}
