...
class AnterosFormRangeSlider extends AnterosFormField<RangeValues> {
...
class _FormBuilderRangeSliderState
    extends AnterosFormFieldState<AnterosFormRangeSlider, RangeValues> {}
