...
/// [AnterosFormCnhField] é usado para mudar a entrada de dados CNH.

/// Uma entrada de campo de Placa de design de material.
class AnterosFormCnhField extends AnterosFormField<String> {
  ...
  final AnterosInputFormatType inputFormatType = AnterosInputFormatType.cnh;
    ...
    this.mouseCursor,
        ...
        super(
          ...
          validator: AnterosFormValidators.compose(fieldFequired
              ? [AnterosFormValidators.cnh(), AnterosFormValidators.required()]
              : [AnterosFormValidators.cnh()]),
          ...
          builder: (FormFieldState<String?> field) {
            ...
            List<TextInputFormatter> formatters =
                AnterosInputFormatType.cnh.inputFormatters;
            ...
            InputDecoration inputDecoration =
                AnterosFormHelper.getAnterosDecorationPattern(
                    hasError, onClearValue, theme, "CNH", hintText, field);
...
class _FormBuilderTextFieldState
    extends AnterosFormFieldState<AnterosFormCnhField, String> {
