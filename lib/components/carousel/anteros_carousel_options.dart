...
enum AnterosCarouselPageChangedReason { timed, manual, controller }

enum AnterosCenterPageEnlargeStrategy { scale, height }

class AnterosCarouselOptions {
  ...
  /// The initial page to show when first creating the [AnterosCarouselSlider].
  ///
  /// Defaults to 0.
  ...
  final Function(int index, AnterosCarouselPageChangedReason reason)?
      onPageChanged;
  ...
  final AnterosCenterPageEnlargeStrategy enlargeStrategy;
  ...
  AnterosCarouselOptions({
    ...
    this.pageViewKey,
    this.enlargeStrategy: AnterosCenterPageEnlargeStrategy.scale,
  ...
  AnterosCarouselOptions copyWith(
          {double? height,
          double? aspectRatio,
          ...
          Function(int index, AnterosCarouselPageChangedReason reason)?
              onPageChanged,
          ...
          AnterosCenterPageEnlargeStrategy? enlargeStrategy,
          bool? disableCenter,
          Clip? clipBehavior,
          bool? padEnds}) =>
      AnterosCarouselOptions(
