...
class AnterosTimelines extends BoxScrollView {
  ...
  ///
  /// Providing a non-null `itemCount` improves the ability of the [AnterosTimelines] to
  ...
  /// [AnterosTimelines] itself is created, it is more efficient to use the [AnterosTimelines]
  ...
  /// may be null.
  ///
  /// [AnterosTimeline.builder] by default does not support child reordering. If you
  /// are planning to change child order at a
  /// later time, consider using [AnterosTimelines] or [Timeline.custom].
  factory AnterosTimelines.tileBuilder({
    Key? key,
    required AnterosTimelineTileBuilder builder,
  ...
  /// [AnterosTimeline.builder] because it will create the widget children lazily as
  /// necessary.
  ///
  /// The `addAutomaticKeepAlives` argument corresponds to the
  ...
  /// [AnterosTimeline.builder] by default does not support child reordering. If you
  /// are planning to change child order at a
  /// later time, consider using [AnterosTimelines] or [AnterosTimeline.custom].
  AnterosTimelines.builder({
    Key? key,
    Axis? scrollDirection,
    bool reverse = false,
    ScrollController? controller,
  ...
  /// A delegate that provides the children for the [AnterosTimelines].
  ///
  /// The [Timeline.custom] constructor lets you specify this delegate
  /// explicitly. The [AnterosTimelines] and [Timeline.builder] constructors create a
  ...
  final AnterosTimelineThemeData? theme;
  ...
  Widget buildChildLayout(BuildContext context) {
    ...
    if (this.theme != null) {
      theme = this.theme;
    } else if (scrollDirection != AnterosTimelineTheme.of(context).direction) {
      theme =
          AnterosTimelineTheme.of(context).copyWith(direction: scrollDirection);
    }
...
/// timeline theme.
class AnterosFixedTimelines extends StatelessWidget {
  /// Creates a timeline flex layout.
  factory AnterosFixedTimelines.tileBuilder({
    Key? key,
    required AnterosTimelineTileBuilder builder,
    AnterosTimelineThemeData? theme,
    Axis? direction,
  ...
  Widget build(BuildContext context) {
    ...
    if (this.direction != null) {
      if (direction != AnterosTimelineTheme.of(context).direction) {
        theme = AnterosTimelineTheme.of(context)
            .copyWith(direction: this.direction);
      }
