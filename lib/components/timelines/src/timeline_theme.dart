...
///
/// Descendant widgets obtain the current theme's [AnterosTimelineThemeData] object
/// using [AnterosTimelineTheme.of]. When a widget uses [AnterosTimelineTheme.of], it is
/// automatically rebuilt if the theme later changes, so that the changes can be
/// applied.
///
/// See also:
///
///  * [AnterosTimelineThemeData], which describes the actual configuration of a theme.
class AnterosTimelineTheme extends StatelessWidget {
  /// Applies the given theme [data] to [child].
  ///
  /// The [data] and [child] arguments must not be null.
  const AnterosTimelineTheme({
    Key? key,
    required this.data,
    required this.child,
  }) : super(key: key);
  ...
  final AnterosTimelineThemeData data;
  ...
  static final AnterosTimelineThemeData _kFallbackTheme =
      AnterosTimelineThemeData.fallback();

  /// The data from the closest [AnterosTimelineTheme] instance that encloses the given
  /// context.
  ///
  /// Defaults to [new ThemeData.fallback] if there is no [Theme] in the given
  /// build context.
  ///
  /// When the [AnterosTimelineTheme] is actually created in the same `build` function
  /// (possibly indirectly, e.g. as part of a [AnterosTimelines]), the `context`
  /// argument to the `build` function can't be used to find the [AnterosTimelineTheme]
  ...
  /// }
  /// ```
  static AnterosTimelineThemeData of(BuildContext context) {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<AnterosTimelineThemeData>('data', data,
        showName: false));
  }
}
...
class _InheritedTheme extends InheritedTheme {
  ...
  final AnterosTimelineTheme theme;
  ...
  Widget wrap(BuildContext context, Widget child) {
    ...
    return identical(this, ancestorTheme)
        ? child
        : AnterosTimelineTheme(data: theme.data, child: child);
  }
...
/// Defines the configuration of the overall visual [AnterosTimelineTheme] for a
/// [AnterosTimelines] or a widget subtree within the app.
///
/// The [AnterosTimelines] theme property can be used to configure the appearance of the
/// entire timeline. Widget subtree's within an timeline can override the
/// timeline's theme by including a [AnterosTimelineTheme] widget at the top of the
/// subtree.
///
/// Widgets whose appearance should align with the overall theme can obtain the
/// current theme's configuration with [AnterosTimelineTheme.of].
///
/// The static [AnterosTimelineTheme.of] method finds the [AnterosTimelineThemeData] value
...
/// little confusing because [AnterosTimelineTheme.of] can not see a [AnterosTimelineTheme]
...
/// [AnterosTimelineTheme], or insert a widget that creates a new BuildContext, like
/// [Builder].
///
/// {@tool snippet}
...
/// {@tool snippet}
@immutable
class AnterosTimelineThemeData with Diagnosticable {
  /// Create a [AnterosTimelineThemeData] that's used to configure a [AnterosTimelineTheme].
  ///
  /// See also:
  ///
  ...
  ///  TimelineThemeData.
  factory AnterosTimelineThemeData({
    Axis? direction,
    Color? color,
    double? nodePosition,
    bool? nodeItemOverlap,
    double? indicatorPosition,
    AnterosIndicatorThemeData? indicatorTheme,
    AnterosConnectorThemeData? connectorTheme,
  }) {
    ...
    return AnterosTimelineThemeData.raw(
      direction: direction,
      color: color,
  ...
  ///
  /// This is used by [AnterosTimelineTheme.of] when no theme has been specified.
  factory AnterosTimelineThemeData.fallback() =>
      AnterosTimelineThemeData.vertical();

  /// Create a [AnterosTimelineThemeData] given a set of exact values. All the values
  ...
  const AnterosTimelineThemeData.raw({
  ...
  factory AnterosTimelineThemeData.vertical() => AnterosTimelineThemeData(
        direction: Axis.vertical,
      );

  /// A default horizontal theme.
  factory AnterosTimelineThemeData.horizontal() => AnterosTimelineThemeData(
  ...
  final AnterosIndicatorThemeData indicatorTheme;

  /// A theme for customizing the appearance and layout of
  /// [ThemedConnectorComponent] widgets.
  final AnterosConnectorThemeData connectorTheme;

  /// Creates a copy of this theme but with the given fields replaced with the
  /// new values.
  AnterosTimelineThemeData copyWith({
    Axis? direction,
    Color? color,
    double? nodePosition,
    bool? nodeItemOverlap,
  ...
  static AnterosTimelineThemeData lerp(
      AnterosTimelineThemeData a, AnterosTimelineThemeData b, double t) {
    ...
    return AnterosTimelineThemeData.raw(
      ...
      indicatorTheme:
          AnterosIndicatorThemeData.lerp(a.indicatorTheme, b.indicatorTheme, t),
      connectorTheme:
          AnterosConnectorThemeData.lerp(a.connectorTheme, b.connectorTheme, t),
    );
  }
  ...
  bool operator ==(Object other) {
    ...
    // hashValues() and in the raw constructor and in the order of fields in
    // the class and in the lerp() method.
    return other is AnterosTimelineThemeData &&
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    final defaultData = AnterosTimelineThemeData.fallback();
    properties
      ...
      ..add(DiagnosticsProperty<AnterosIndicatorThemeData>(
        'indicatorTheme',
        indicatorTheme,
        defaultValue: defaultData.indicatorTheme,
        level: DiagnosticLevel.debug,
      ))
      ..add(DiagnosticsProperty<AnterosConnectorThemeData>(
        'connectorTheme',
        connectorTheme,
