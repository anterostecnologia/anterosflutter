...
/// See also:
///
///  * [AnterosSolidLineConnector], which is a [AnterosConnector] that draws solid line.
///  * [DashedLineConnector], which is a [AnterosConnector] that draws outlined dot.
///  * [TransparentConnector], which is a [AnterosConnector] that only takes up space.
abstract class AnterosConnector extends StatelessWidget
    with ThemedConnectorComponent {
  /// Creates an connector.
  const AnterosConnector({
    Key? key,
    this.direction,
    this.space,
    this.thickness,
  ...
  /// See also:
  ///
  /// * [AnterosSolidLineConnector],  exactly the same.
  factory AnterosConnector.solidLine({
    Key? key,
    Axis? direction,
    double? thickness,
    double? space,
  ...
  factory AnterosConnector.dashedLine({
    Key? key,
    Axis? direction,
    double? thickness,
    double? dash,
  ...
  factory AnterosConnector.transparent({
    Key? key,
    Axis? direction,
    double? indent,
    double? endIndent,
  ...
  ///
  /// If this is null, then the [AnterosConnectorThemeData.indent] is used. If that is
  ...
  ///
  /// If this is null, then the [AnterosConnectorThemeData.color] is used. If that is
  /// also null, then [AnterosTimelineThemeData.color] is used.
  @override
  final Color? color;
}
...
class AnterosSolidLineConnector extends AnterosConnector {
  /// Creates a solid line connector.
  ///
  /// The [thickness], [space], [indent], and [endIndent] must be null or
  /// non-negative.
  const AnterosSolidLineConnector({
    Key? key,
    Axis? direction,
    double? thickness,
    double? space,
...
///
/// The appropriate padding is automatically computed from the cross axis size.
class DecoratedLineConnector extends AnterosConnector {
  ...
  ///
  /// Use the [AnterosSolidLineConnector] class to specify a simple solid color line.
...
/// See also:
///
///  * [AnterosDashedLinePainter], which is painter that draws this connector.
class DashedLineConnector extends AnterosConnector {
  /// Creates a dashed line connector.
  ///
  /// The [thickness], [space], [indent], and [endIndent] must be null or
  /// non-negative.
  ...
  Widget build(BuildContext context) {
    ...
    return _ConnectorIndent(
      ...
      child: CustomPaint(
        painter: AnterosDashedLinePainter(
          direction: direction,
...
/// A transparent connector for start, end [AnterosTimelineNode] of the [AnterosTimelines].
///
/// This connector will be not displayed, it only occupies an area.
class TransparentConnector extends AnterosConnector {
