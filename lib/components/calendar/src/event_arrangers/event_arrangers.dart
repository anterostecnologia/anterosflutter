...
abstract class AnterosEventArranger<T> {
  /// [AnterosEventArranger] defines how simultaneous events will be arranged.
  /// Implement [arrange] method to define how events will be arranged.
  ///
  /// There are three predefined class that implements of [AnterosEventArranger].
  ///
  /// [_StackEventArranger], [AnterosSideEventArranger] and [AnterosMergeEventArranger].
  ///
  const AnterosEventArranger();
