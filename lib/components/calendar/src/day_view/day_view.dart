...
class AnterosDayView<T> extends StatefulWidget {
  ...
  final AnterosDateWidgetBuilder? dayTitleBuilder;

  /// Defines how events are arranged in day view.
  /// User can define custom event arranger by implementing [AnterosEventArranger]
  ...
  /// [AnterosDayViewState.nextPage] or [AnterosDayViewState.previousPage]
  ...
  /// [AnterosDayView.liveTimeIndicatorSettings]
  ...
  /// [AnterosDayView.timeLineBuilder] by provided offset.
  ///
  ...
  @override
  AnterosDayViewState<T> createState() => AnterosDayViewState<T>();
}

class AnterosDayViewState<T> extends State<AnterosDayView<T>> {
  late double _width;
  late double _height;
  ...
  late AnterosDateWidgetBuilder _dayTitleBuilder;
  ...
  void initState() {
    ...
    _minDate = widget.minDay ?? AnterosCalendarConstants.epochDate;
    _maxDate = widget.maxDay ?? AnterosCalendarConstants.maxDate;
  ...
  /// as [AnterosDayView.pageTransitionDuration] and [AnterosDayView.pageTransitionCurve]
  /// respectively.
  ///
  ///
