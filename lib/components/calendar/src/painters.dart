...
class AnterosHourLinePainter extends CustomPainter {
  /// Color of hour line
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (var i = 1; i < AnterosCalendarConstants.hoursADay; i++) {
  ...
  bool shouldRepaint(covariant CustomPainter oldDelegate) {
    return oldDelegate is AnterosHourLinePainter &&
...
class AnterosCurrentTimeLinePainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(covariant CustomPainter oldDelegate) =>
      oldDelegate is AnterosCurrentTimeLinePainter &&
