...
class AnterosCalendarPageHeader extends StatelessWidget {
  ...
  final AnterosStringProvider dateStringBuilder;
  ...
  const AnterosCalendarPageHeader({
    Key? key,
    required this.date,
    ...
    this.onPreviousDay,
    this.secondaryDate,
    this.backgroundColor = AnterosCalendarConstants.headerBackground,
    this.iconColor = AnterosCalendarConstants.black,
  }) : super(key: key);
