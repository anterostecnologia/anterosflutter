...
class AnterosTile<T> extends StatelessWidget {
  ...
  /// usually used to display chips with AnterosTileChips
  final Widget? body;
  ...
  AnterosTile.fromState(
    AnterosState<T> state, {
    Key? key,
    Widget? value,
  ...
  Widget? get _trailingIconWidget {
    return isLoading != true
        ? trailing != null
            ? trailing
            : AnterosTile.defaultTrailing
        : AnterosTile.defaultLoadingIndicator;
  }
