...
@immutable
class AnterosChoiceStyle with Diagnosticable {
  /// Choices item margin
  ...
  /// Spacing between the avatar/secondary widget and the text widget when [AnterosChoiceConfig.type] is [AnterosChoiceType.cards]
  ...
  final AnterosChoiceControl? control;
  ...
  /// Creates a copy of this [AnterosChoiceStyle] but with
  /// the given fields replaced with the new values.
  AnterosChoiceStyle copyWith({
  ...
  /// Returns a new [AnterosChoiceStyle] that is
  /// a combination of this object and the given [other] style.
  AnterosChoiceStyle merge(AnterosChoiceStyle? other) {
