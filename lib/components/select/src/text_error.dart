...
/// Controller for [AnterosTextError]
class AnterosTextErrorController extends ChangeNotifier {
  /// Default constructor
...
class AnterosTextError extends StatefulWidget {
  ...
  /// Listenable that control the flow of [AnterosTextError] widget
  final AnterosTextErrorController? controller;
  ...
  @override
  _AnterosTextErrorState createState() => _AnterosTextErrorState();
}

class _AnterosTextErrorState extends State<AnterosTextError> {
  /// Listenable that control the flow of [AnterosTextError] widget
  AnterosTextErrorController? controller;

  /// Returns the default controller
  AnterosTextErrorController get defaultController {
    return AnterosTextErrorController(visibled: widget.visibled);
  }
  ...
  @override
  void didUpdateWidget(AnterosTextError oldWidget) {
