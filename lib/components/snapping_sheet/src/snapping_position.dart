...
/// param in a given [AnterosSnappingPosition].
class AnterosGrabbingContentOffset {
...
class AnterosSnappingPosition {
  ...
  /// you usually use [AnterosGrabbingContentOffset.bottom]. See example:
  /// ```dart
  ...
  /// usually use [AnterosGrabbingContentOffset.bottom]. See example:
  /// ```dart
  /// SnappingPosition.factor(
  ///   positionFactor: 0.0,
  ...
  const AnterosSnappingPosition.factor({
  ...
  bool operator ==(other) =>
      other is AnterosSnappingPosition &&
