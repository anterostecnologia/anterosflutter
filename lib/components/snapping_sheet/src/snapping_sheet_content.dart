...
enum AnterosSheetLocation {
  above,
  below,
  unknown,
}

class AnterosSnappingSheetContent {
  /// The size behavior of the sheet. Can either be [AnterosSheetSizeStatic] or
  /// [AnterosSheetSizeFill].
  final AnterosSheetSizeBehavior sizeBehavior;
  ...
  Widget _child;
  AnterosSheetLocation location = AnterosSheetLocation.unknown;

  AnterosSnappingSheetContent({
    required Widget child,
    this.draggable = false,
    this.sizeBehavior = const AnterosSheetSizeFill(),
    this.childScrollController,
  }) : this._child = child;

  double? _getHeight() {
    var sizeBehavior = this.sizeBehavior;
    if (sizeBehavior is AnterosSheetSizeStatic) return sizeBehavior.size;
  }
