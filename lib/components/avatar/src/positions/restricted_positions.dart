...
class RestrictedPositions implements Positions {
  RestrictedPositions({
    ...
    this.align = AnterosStackAlign.left,
    this.infoIndent = 0.0,
    this.laying = AnterosStackLaying.last,
  });
  ...
  late AnterosStackLaying laying;
  ...
  double _getAlignmentOffset() {
    final freeSpace = _width -
        ...
        _infoIndent;
    switch (align) {
      case AnterosStackAlign.left:
        return 0;
      case AnterosStackAlign.right:
        return freeSpace;
      case AnterosStackAlign.center:
        return freeSpace / 2;
      default:
        return 0;
    }
...
class RestrictedAmountPositions extends RestrictedPositions {
  RestrictedAmountPositions({
    ...
    AnterosStackAlign align = AnterosStackAlign.left,
    double infoIndent = 0.0,
    AnterosStackLaying laying = AnterosStackLaying.last,
  }) : super(
