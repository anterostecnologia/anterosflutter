...
class AnterosStackLaying {
  const AnterosStackLaying({
  ...
  static const AnterosStackLaying first = AnterosStackLaying(
    itemPositionNumberAtTop: 0,
    infoItemAtTop: false,
  );
  static const AnterosStackLaying last = AnterosStackLaying(
