...
/// AnterosCircularProfileAvatar allows developers to implement circular profile avatar with border,
...
class AnterosCircularProfileAvatar extends StatefulWidget {
  AnterosCircularProfileAvatar(this.imageUrl,
  ...
  @override
  _AnterosCircularProfileAvatarState createState() =>
      _AnterosCircularProfileAvatarState();
}

class _AnterosCircularProfileAvatarState
    extends State<AnterosCircularProfileAvatar> {
