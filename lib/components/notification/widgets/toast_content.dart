...
class AnterosToastContent extends StatelessWidget {
  const AnterosToastContent({
    Key? key,
    this.title,
  ...
  ///}
  ///```
  final AnterosNotificationType notificationType;
  ...
  Widget _getNotificationIcon() {
    switch (notificationType) {
      case AnterosNotificationType.success:
        return _renderImage(Assets.icons.success.assetName);
      case AnterosNotificationType.error:
        return _renderImage(Assets.icons.error.assetName);
      case AnterosNotificationType.info:
