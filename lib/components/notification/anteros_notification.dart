...
import 'package:anterosflutter/components/notification/resources/colors.dart';
import 'package:anterosflutter/components/notification/resources/extensions.dart';
import 'package:anterosflutter/components/notification/widgets/animated_progress_bar.dart';
import 'package:anterosflutter/components/notification/widgets/toast_content.dart';
import 'package:flutter/material.dart';

// ignore: must_be_immutable
class AnterosNotification extends StatefulWidget {
  AnterosNotification({
    Key? key,
    this.title,
    ...
    this.notificationPosition = AnterosNotificationPosition.topRight,
    ...
    notificationType = AnterosNotificationType.custom;
    ...
    if (notificationPosition == AnterosNotificationPosition.centerRight) {
      assert(
        animation != AnimationType.fromLeft &&
            animation != AnimationType.fromBottom &&
            animation != AnimationType.fromTop,
      );
    } else if (notificationPosition == AnterosNotificationPosition.centerLeft) {
      assert(
        animation != AnimationType.fromRight &&
            animation != AnimationType.fromBottom &&
            animation != AnimationType.fromTop,
      );
    } else if (notificationPosition == AnterosNotificationPosition.topCenter) {
      assert(
        animation != AnimationType.fromBottom &&
            animation != AnimationType.fromLeft &&
            animation != AnimationType.fromRight,
      );
    } else if (notificationPosition == AnterosNotificationPosition.topRight) {
      assert(
        animation != AnimationType.fromLeft &&
            animation != AnimationType.fromBottom,
      );
    } else if (notificationPosition == AnterosNotificationPosition.topLeft) {
      assert(
        animation != AnimationType.fromRight &&
            animation != AnimationType.fromBottom,
      );
    } else if (notificationPosition ==
        AnterosNotificationPosition.bottomCenter) {
      assert(
        animation != AnimationType.fromTop &&
            animation != AnimationType.fromLeft &&
            animation != AnimationType.fromRight,
    ...
    } else if (notificationPosition == AnterosNotificationPosition.bottomLeft) {
      assert(
        animation != AnimationType.fromRight &&
            animation != AnimationType.fromTop,
      );
  ...
  AnterosNotification.success({
    ...
    notificationType = AnterosNotificationType.success;
  ...
  AnterosNotification.error({
    ...
    notificationType = AnterosNotificationType.error;
  ...
  AnterosNotification.info({
    ...
    notificationType = AnterosNotificationType.info;
  ...
  ///}
  ///```
  late AnterosNotificationType notificationType;
  ...
  ///default value `top`
  ///
  final AnterosNotificationPosition notificationPosition;
  ...
  @override
  _AnterosNotificationState createState() => _AnterosNotificationState();
}

class _AnterosNotificationState extends State<AnterosNotification>
