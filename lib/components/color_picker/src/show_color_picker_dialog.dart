...
Future<Color> showColorPickerDialog(
  ...
  Map<ColorPickerType, String> pickerTypeLabels =
    ...
    ColorPickerType.primary: AnterosColorPicker._selectPrimaryLabel,
    ColorPickerType.accent: AnterosColorPicker._selectAccentLabel,
    ColorPickerType.bw: AnterosColorPicker._selectBlackWhiteLabel,
    ColorPickerType.both: AnterosColorPicker._selectBothLabel,
    ColorPickerType.custom: AnterosColorPicker._selectCustomLabel,
    ColorPickerType.wheel: AnterosColorPicker._selectWheelAnyLabel,
  },
