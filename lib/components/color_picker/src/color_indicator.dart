...
@immutable
class AnterosColorIndicator extends StatefulWidget {
  /// Default const constructor for the color indicator.
  const AnterosColorIndicator({
    Key? key,
    this.onSelect,
  ...
  @override
  _AnterosColorIndicatorState createState() => _AnterosColorIndicatorState();
}

class _AnterosColorIndicatorState extends State<AnterosColorIndicator> {
  ...
  @override
  void didUpdateWidget(covariant AnterosColorIndicator oldWidget) {
