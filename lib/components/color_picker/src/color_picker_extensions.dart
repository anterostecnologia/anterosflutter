...
/// alpha channel value.
extension AnterosPickerNoNullColorExtensions on Color {
...
extension AnterosPickerNoNullStringExtensions on String {
  //
...
extension AnterosPickerNullableStringExtensions on String? {
  //
  /// Convert a HEX value encoded (A)RGB string to a Dart Color.
  ///
  /// * The string may include the '#' char, but does not have to.
