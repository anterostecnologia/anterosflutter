...
/// [AnterosArrowClipper] that can be used with [ClipPath] to clip widget in Arrow shape

class AnterosArrowClipper extends CustomClipper<Path> {
  AnterosArrowClipper(this.triangleHeight, this.rectangleClipHeight, this.edge);
  ...
  bool shouldReclip(CustomClipper<Path> oldClipper) {
    AnterosArrowClipper oldie = oldClipper as AnterosArrowClipper;
