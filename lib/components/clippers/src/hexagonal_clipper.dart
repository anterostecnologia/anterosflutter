...
/// [AnterosHexagonalClipper], can be used with [ClipPath] widget, and clips the widget in Hexagon shape
class AnterosHexagonalClipper extends CustomClipper<Path> {
  final bool reverse;

  AnterosHexagonalClipper({this.reverse = false});
