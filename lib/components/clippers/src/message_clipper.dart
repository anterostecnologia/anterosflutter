...
/// [AnterosMessageClipper], can be used with [ClipPath] widget, and clips the widget in dialog box shape
class AnterosMessageClipper extends CustomClipper<Path> {
  AnterosMessageClipper({this.borderRadius = 15});
