...
class AnterosEasyContainer extends StatefulWidget {
  const AnterosEasyContainer({
    Key? key,
    required this.child,
    this.onTap,
    this.height,
  ...
  /// Called every time [AnterosEasyContainer] is tapped;
  ...
  /// Height of the [AnterosEasyContainer].
  final double? height;

  /// Width of the [AnterosEasyContainer].
  final double? width;
  ...
  @override
  _AnterosEasyContainerState createState() => _AnterosEasyContainerState();
}

class _AnterosEasyContainerState extends State<AnterosEasyContainer> {
