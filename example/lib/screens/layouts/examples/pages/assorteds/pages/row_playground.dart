...
class RowPlaygroundPage extends StatefulWidget {
  @override
  _RowPlaygroundPageState createState() => _RowPlaygroundPageState();
}

class _RowPlaygroundPageState extends State<RowPlaygroundPage> {
  late int itemCount;
  late double height;
  late double width;
  late double outer;
              ...
              children: <Widget>[
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    const AnterosBox(width: 10.0),
                    button(
                        "- Height", () => height -= (height > 0.0) ? 1.0 : 0.0),
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    button(
                        ...
                        withSeparator
                            ? () => separatorWidth -=
                                (separatorWidth > 0.0) ? 1.0 : 0.0
                            : null),
                    button("+ Sep",
                        withSeparator ? () => separatorWidth += 1.0 : null),
                    Text("   $separatorWidth"),
                  ],
                ),
                Row(
                  ...
                  children: <Widget>[
                    button("Parent Height = $parentHeight", () {
                      ...
                      else if (parentHeight == double.infinity)
                        parentHeight = null;
                    }),
                    const AnterosBox(width: 10.0),
                ...
                button("Intrinsic Width/Height = $intrinsic",
                    () => intrinsic = !intrinsic),
              ],
            ),
          ),
  ...
  Widget button(String label, VoidCallback? func,
