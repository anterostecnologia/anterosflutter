...
class ColumnPlaygroundPage extends StatefulWidget {
  @override
  _ColumnPlaygroundPageState createState() => _ColumnPlaygroundPageState();
}

class _ColumnPlaygroundPageState extends State<ColumnPlaygroundPage> {
  late int itemCount;
  late double width;
  late double height;
  late double outer;
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    button(
                        ...
                        withSeparator
                            ? () => separatorHeight -=
                                (separatorHeight > 0.0) ? 1.0 : 0.0
                            : null),
                    button("+ Sep",
                        withSeparator ? () => separatorHeight += 1.0 : null),
