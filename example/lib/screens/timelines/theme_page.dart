...
class _ThemePageState extends State<ThemePage> {
  ...
  late AnterosTimelineThemeData _theme;

  @override
  void initState() {
    super.initState();
    _theme = AnterosTimelineThemeData();
  }

  void _updateTheme(AnterosTimelineThemeData theme) {
    if (_theme != theme) {
      setState(() {
        _theme = theme;
      });
                  ...
                  children: [
                    AnterosTimelineTile(
                      ...
                      node: AnterosTimelineNode(
                        ...
                        indicator: AnterosOutlinedDotIndicator(),
                      ),
