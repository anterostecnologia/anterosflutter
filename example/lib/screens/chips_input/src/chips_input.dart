...
class AnterosChipsInput<T> extends StatefulWidget {
  ...
  @override
  AnterosChipsInputState<T> createState() => AnterosChipsInputState<T>();
}

class AnterosChipsInputState<T> extends State<AnterosChipsInput<T>>
  ...
  @override
  void didUpdateWidget(covariant AnterosChipsInput<T> oldWidget) {
