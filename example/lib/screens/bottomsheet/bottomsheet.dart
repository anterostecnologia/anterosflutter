...
class _BottomSheetPageState extends State<BottomSheetPage> {
  final AnterosBottomSheetController _controller =
      AnterosBottomSheetController();
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        bottomSheet: AnterosBottomSheet(
...
//           stickyHeader: const AnterosListTile(
