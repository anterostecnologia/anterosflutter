...
class AnterosBadge extends StatefulWidget {
  ...
  AnterosBadge({
    ...
    this.toAnimate = true,
    this.position,
    this.shape = AnterosBadgeShape.circle,
    this.padding = const EdgeInsets.all(5.0),
    this.animationDuration = const Duration(milliseconds: 500),
    this.borderRadius = BorderRadius.zero,
    this.alignment = Alignment.center,
    this.animationType = AnterosBadgeAnimationType.slide,
    this.showBadge = true,
  ...
  ///
  /// The default value is [AnterosBadgeAnimationType.slide].
  ///
  /// See also:
  ///
  /// * [toAnimate]
  /// * [animationDuration]
  final AnterosBadgeAnimationType animationType;

  /// Allows to set the shape to this [badgeContent].
  ///
  /// The default value is [AnterosBadgeShape.circle].
  ...
  @override
  AnterosBadgeState createState() {
    return AnterosBadgeState();
  }
}

class AnterosBadgeState extends State<AnterosBadge>
  ...
  void initState() {
    ...
    if (widget.animationType == AnterosBadgeAnimationType.slide) {
      _animation = CurvedAnimation(
          parent: _animationController, curve: Curves.elasticOut);
    } else if (widget.animationType == AnterosBadgeAnimationType.scale) {
      _animation = _scaleTween.animate(_animationController);
    } else if (widget.animationType == AnterosBadgeAnimationType.fade) {
      _animation =
  ...
  Widget _getBadge() {
    final border = widget.shape == AnterosBadgeShape.circle
        ...
        child: Material(
          ...
          child: Container(
            decoration: BoxDecoration(
              ...
              shape: widget.shape == AnterosBadgeShape.circle
                  ? BoxShape.circle
                  : BoxShape.rectangle,
            ),
            child: Padding(
